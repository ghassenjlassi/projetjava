...
public class EditorFrame extends JFrame
{
	...
	public EditorFrame() throws HeadlessException
	{
		...
		history = new HistoryManager<>(drawingModel, historyLength);
		...
		btnUndoButton.setAction(undoAction);
		...
		btnNewButton.setAction(clearAction);
		toolBar.add(btnNewButton);
		
		JToggleButton tglbtnNewToggleButton = new JToggleButton("Edit");
		tglbtnNewToggleButton.setAction(toggleCreateEditAction);
		((ToggleCreateEditAction) toggleCreateEditAction).registerButton(tglbtnNewToggleButton);
		toolBar.add(tglbtnNewToggleButton);
		
		JButton btnNewButton_1 = new JButton("New button");
		btnNewButton_1.setAction(moveUpAction);
		toolBar.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("New button");
		btnNewButton_2.setAction(moveDownAction);
		toolBar.add(btnNewButton_2);
		
		JButton btnNewButton_3 = new JButton("New button");
		btnNewButton_3.setAction(deleteAction);
		toolBar.add(btnNewButton_3);
		
		JButton btnNewButton_4 = new JButton("New button");
		btnNewButton_4.setAction(styleAction);
		...
		JLabeledComboBox lineTypeComboBox = new JLabeledComboBox("Line Type",
				LineType.stringValues(), 1,
		...
		JLabel lblNewLabel = new JLabel("Edge Width");
		edgeWidthPanel.add(lblNewLabel);
		...
		treesPanel.setTreeType(TreeType.FIGURE);
		...
		upMenu.setAction(moveUpAction);
		mnEdition.add(upMenu);
		
		JMenuItem downMenu = new JMenuItem("Down");
		downMenu.setAction(moveDownAction);
		mnEdition.add(downMenu);
		...
		styleMenu.setAction(styleAction);
		mnEdition.add(styleMenu);
		
		JCheckBoxMenuItem editionMenu = new JCheckBoxMenuItem("Edit");
		editionMenu.setAction(toggleCreateEditAction);
		((ToggleCreateEditAction) toggleCreateEditAction).registerButton(editionMenu);
		mnEdition.add(editionMenu);
	...
	private class ToggleCreateEditAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			while(it.hasNext()){
				it.next().getModel().setSelected(selected);	
			}
			if(selected){
	...
	private class FillColorFilterAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (selected)
			{
				drawingModel.setFillColorFilter(new FillColorFilter(drawingModel
				        .getFillpaint()));
			}
			else
			{
	...
	private class EdgeColorFilterAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			// TODO Compléter ...
			if (selected)
			{drawingModel.setEdgeColorFilter(new EdgeColorFilter(drawingModel
				        .getEdgePaint()));}
			else
	...
	private class StyleAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			drawingModel.applyStyleToSelected(drawingModel.getFillpaint()
					,drawingModel.getEdgePaint(),drawingModel.getStroke());
			//complet...
		}
	}
