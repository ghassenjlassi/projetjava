...
public class ScaleShapeListener extends AbstractTransformShapeListener
{
	...
	public void init()
	{
		...
		if (currentFigure != null)
		{
			...
			bounds=currentFigure.getBounds2D();
	...
	public void updateDrag(MouseEvent e)
	{
		...
		if(dx/bounds.getWidth()!=-1 && (dy/bounds.getHeight())!=-1){
		AffineTransform scale = AffineTransform.getScaleInstance(1+(dx/bounds.getWidth()),1+(dy/bounds.getHeight()));
