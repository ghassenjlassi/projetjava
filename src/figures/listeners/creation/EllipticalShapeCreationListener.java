 ...
 * @author davidroussel
 */
public class EllipticalShapeCreationListener extends AbstractCreationListener
{
	/**
	 ...
	 */
	public EllipticalShapeCreationListener(Drawing model, JLabel tipLabel)
	{
		super(model, null, tipLabel, 2);
