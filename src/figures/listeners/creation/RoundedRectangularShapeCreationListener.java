 ...
 * @author davidroussel
 */
public class RoundedRectangularShapeCreationListener extends AbstractCreationListener
{
	/**
	 ...
	 */
	public RoundedRectangularShapeCreationListener(Drawing model, HistoryManager<Figure> history, JLabel tipLabel)
	{
